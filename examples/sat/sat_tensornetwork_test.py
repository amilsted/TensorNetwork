...
class SATTensorNetworkTest(tf.test.TestCase):
  ...
  def test_sanity_check(self):
    ...
    count = tensornetwork.contractors.auto(nodes).get_tensor()
  ...
  def test_solutions(self):
    nodes, edge_order = sat_tensornetwork.sat_tn([
        (1, 2, -3),
    ])
    solutions_node = tensornetwork.contractors.auto(nodes)
    solutions_node.reorder_edges(edge_order)
